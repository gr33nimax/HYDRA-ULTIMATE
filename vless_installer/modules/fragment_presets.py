...
def do_fragment_presets_menu() -> None:
    ...
    _box_desc(
        "Создаёт полный набор клиентских конфигов Xray с разными параметрами "
        "фрагментации — от агрессивных до лёгких. Скачайте все на своё "
        "устройство и попробуйте каждый: оставьте тот, где лучше скорость."
    )
    _box_sep()
