...
- Добавлены профили транспорта XHTTP `balanced`, `low_latency`, `stealth` и
  `cdn`: одна команда согласованно выставляет режим и весь набор параметров.
  Профиль и сводка тюнинга видны в статусе плагина и в TUI.
