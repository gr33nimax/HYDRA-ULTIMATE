...
**Релизы:** [2.6.0](#260--2-августа-2026) · [2.5.5](#255--27-июля-2026) · [2.5.4](#254--26-июля-2026) ·
...
- В управление creator добавлены отдельные действия «Пересоздать звонки сейчас»,
  «Завершить все звонки» и «Интервал пересоздания». Stop-action отключает четыре
  unit и удаляет ставшую недействительной master-ссылку до следующего due-cycle.
