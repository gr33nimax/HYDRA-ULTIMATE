...
- README ветки `main` согласован с release-каналом: CI badge, bootstrap и updater
  используют `main`, а публичные команды полагаются на безопасное значение
  `HYDRA_REF=main` по умолчанию.
