...
def call_mode(state: PluginStateAccess) -> str:
...
def user_password(user: User) -> str:
...
def _listen_port(state: PluginStateAccess, config: dict) -> int:
...
def multi_user_inbound(state: PluginStateAccess) -> dict:
