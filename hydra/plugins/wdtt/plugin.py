...
from hydra.plugins.wdtt.model import (
    ACCESS_FILE, BIN_PATH,
    CONFIG_DIR, CONFIG_FILE,
    DEFAULT_DTLS_PORT, DEFAULT_WG_PORT,
    DEFAULT_WG_SUBNET, GITHUB_REPO,
    GO_BUILD_TIMEOUT, GO_DL_URL,
    GO_MODULE_TIMEOUT, HEADLESS_BIN_PATH,
    HEADLESS_CALL_COUNT, HEADLESS_COOKIES_FILE,
    HEADLESS_GITHUB_REPO, HEADLESS_LINK_FILE,
