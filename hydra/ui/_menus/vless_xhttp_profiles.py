    ...
    while True:
        ...
        panel(
            ...
            [
                ...
                "",
                "Профиль выставляет режим XHTTP, паддинг, размер и число",
                "upload-запросов и время жизни потока одной транзакцией.",
                "Клиенты получают новые параметры через подписку или ссылку.",
            ],
        )
        print()
        options = [
