...
При включённом WDTT общий apply пересобирает сервер из зафиксированной ревизии
`gr33nimax/hydra-wdtt`, а не из плавающей ветки upstream. После обновления первый
apply создаёт `/etc/wdtt/hydra-access.json`; файл содержит только verifier-данные
HydraBox grants и имеет права `0600`.
