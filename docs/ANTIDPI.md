...
Offense counter сохраняется после истечения TTL и после ручного разбана. После
перезапуска активные записи возвращаются в ipset с оставшимся TTL. История
хранит до 1000 последних записей.
