...
ядром. Если проверка конфигурации или запуск службы завершается ошибкой,
транзакция восстанавливает и прежний бинарник, и исходный конфиг. DNS-секция,
принадлежащая плагину, автоматически не переписывается.
