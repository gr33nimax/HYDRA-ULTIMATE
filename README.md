...
на экране пользователя «Ручные конфиги» и не добавляется в его подписку. Вместо
общего master-пароля HydraBox Subscription v2 выдаёт нативный WDTT endpoint с
per-device grant внутри JWE: 9 воркеров минимум, 18 по умолчанию, 36 максимум и
15-минутный lease с автоматическим обновлением через VK relay.
