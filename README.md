...
У доменных транспортов есть сайт-заглушка, клиентские ссылки и профили выдаются
через сервер подписок и TUI. Полная карта модулей, портов, служб и файлов —
...
службы восстанавливаются автоматически.
