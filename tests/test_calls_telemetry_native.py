...
def test_four_lane_session_metrics_are_accepted_as_one_complete_record(
    ...
    payload = {
        ...
        "metrics": {
            ...
            "kcp_rto_ms": 120,
            "kcp_rttvar_ms": 12,
            "kcp_rtt_samples_total": 80,
            "kcp_ack_segments_total": 100,
            "kcp_ack_progress_segments_total": 75,
            "kcp_inflight_segments": 8,
            "kcp_fast_retrans_estimate_segments_total": 10,
            "kcp_fast_retrans_estimate_bytes_total": 10_000,
            "kcp_rto_retrans_estimate_segments_total": 5,
